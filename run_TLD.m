...
% jorgeb - Change second parameter of the struct to 0 for recorded video or 1 for webcam
% jorgeb - For recorded video, use this one:
...
% jorgeb - For webcam, use this one:
...
% Save results ------------------------------------------------------------
% jorgeb - Turned off for now.
% jorgeb - ToDo - Preserve output for each object tracked.

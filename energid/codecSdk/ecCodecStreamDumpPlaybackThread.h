#ifndef ecCodecStreamDumpPlaybackThread_H_
#define ecCodecStreamDumpPlaybackThread_H_
...
//---------------------------------------------------------------------------
class EcCodecStreamDumpPlaybackThread
{
public:
   ...
   /// Constructor
   EcCodecStreamDumpPlaybackThread
      (
      bool realtime = true
      );
...
#endif // ecCodecStreamDumpPlaybackThread_H_
